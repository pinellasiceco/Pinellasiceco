...
const DEEP_CLEAN = {
  ...
  'Hoshizaki': {
    time: '90-120 min',
    chemicals: ['Nu-Calgon Nickel-Safe Cleaner: 8oz per gallon — CRITICAL: Hoshizaki evaporators have tin plating that is damaged by standard acid cleaners. Nickel-Safe is correct.', 'Nu-Calgon No-Rinse Sanitizer: 1oz per gallon', 'Extra rinse water — Hoshizaki requires more thorough rinsing than other brands'],
    steps: [
      {
        title: 'Safety & Setup — Hoshizaki Specific',
        detail: 'Power off and unplug. IMPORTANT Hoshizaki note: their evaporators use tin-plated copper tubes. Standard acid descalers (like those used on Manitowoc) will damage and pit this surface permanently. Always confirm you are using Nickel-Safe cleaner. The damage from wrong chemicals is irreversible and expensive. Set up cart, mix cleaner (8oz per gallon warm water), mix sanitizer (1oz per gallon). Gloves on.',
      },
      {
...
const MAINTENANCE_60 = {
  ...
  'Hoshizaki': {
    ...
    steps: [
      ...
      {title:'Evaporator Visual Check', detail:'Look at evaporator surface. Hoshizaki tin plating should be uniformly silver. Any brown, orange, or dark spots: biofilm forming. Light surface biofilm can be wiped with sanitizer solution. More than light spots: elevate to deep clean. Never use abrasive on Hoshizaki evaporator at any service level.'},
