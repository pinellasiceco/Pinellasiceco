...
function openServiceLog(id){
  ...
  var _svb=document.getElementById('svc-submit-btn');
  if(_svb){
    var _svFn=function(e){e.preventDefault();e.stopPropagation();submitServiceLog(id);};
    _svb.addEventListener('touchend',_svFn,false);
    _svb.addEventListener('click',_svFn,false);
  }
}
