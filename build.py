...
<div id="app">
  ...
  <div class="panel" id="p-all">
    ...
    <div id="debug-test" style="display:none;padding:8px;background:#fef3c7;border:2px solid #f59e0b;border-radius:8px;margin-bottom:8px"><div style="font-size:10px;font-weight:700;color:#92400e;margin-bottom:6px">TAP TEST — if this opens a card, delegation is the issue</div><button onclick="debugTestBtn()" ontouchend="event.preventDefault();debugTestBtn()" style="padding:10px 16px;background:#dc2626;color:#fff;border:none;border-radius:8px;font-size:14px;font-weight:700;cursor:pointer;font-family:inherit;width:100%;touch-action:manipulation">🔴 TAP HERE — Open First Card Details</button></div><div class="grid" id="agrid"></div>
