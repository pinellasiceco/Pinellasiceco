...
function cardHTML(p){
  ...
  return '<div class="card '+p.priority+(isC(p.id)?' done':'')+'" data-id="'+p.id+'">'
    ...
    +lastH
    +'<div class="cacts">'
      +'<button class="btn blog" class="log-call-btn" data-id="'+p.id+'" data-action="openM" onclick="event.stopPropagation();openM('+p.id+')" ontouchend="event.stopPropagation();event.preventDefault();openM('+p.id+')" style="touch-action:manipulation">Log Call</button>'
      +'<button class="btn" data-action="openM" onclick="event.stopPropagation();openM('+p.id+')" ontouchend="event.stopPropagation();event.preventDefault();openM('+p.id+')" style="background:#0f1f38;color:#fff;border-color:#0f1f38;touch-action:manipulation">Details</button>'
