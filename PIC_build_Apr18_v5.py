...
<div id="app">
  ...
  <div id="queue-bg" style="display:none;position:fixed;inset:0;background:var(--bg);z-index:90;flex-direction:column">
    ...
    <div style="padding:12px 16px;padding-bottom:max(12px,env(safe-area-inset-bottom));background:var(--surf);border-top:1px solid var(--brd2);display:grid;grid-template-columns:repeat(3,1fr);gap:8px;flex-shrink:0;position:relative;z-index:2" id="queue-actions">
      <button class="qbtn qbtn-green"  ontouchend="event.preventDefault();queueLog('intro_set')" onclick="queueLog('intro_set')"  >&#x1F4C5; Intro Set</button>
      <button class="qbtn qbtn-yellow" ontouchend="event.preventDefault();queueLog('in_play')" onclick="queueLog('in_play')"    >&#x1F7E1; In Play</button>
      <button class="qbtn qbtn-blue"   ontouchend="event.preventDefault();queueLog('no_contact')" onclick="queueLog('no_contact')" >&#x1F6AA; No Contact</button>
      <button class="qbtn qbtn-red"    ontouchend="event.preventDefault();queueLog('not_now')" onclick="queueLog('not_now')"    >&#x274C; Not Now</button>
      <button class="qbtn qbtn-gray"   ontouchend="event.preventDefault();queueLog('voicemail')" onclick="queueLog('voicemail')"  >&#x1F4F2; Voicemail</button>
      <button class="qbtn qbtn-gray"   ontouchend="event.preventDefault();queueLog('dead')" onclick="queueLog('dead')"       >&#x26AB; Dead</button>
    </div>
  </div>
