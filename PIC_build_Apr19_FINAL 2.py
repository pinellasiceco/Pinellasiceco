...
function showCard(id){
  ...
  var logH='<div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:10px;padding:12px;margin-bottom:10px">'
    ...
    +'<button data-fupdays="60" style="padding:9px 4px;border:1px solid #e2e8f0;border-radius:7px;background:#f8fafc;color:#475569;font-size:11px;font-weight:600;cursor:pointer;font-family:inherit;touch-action:manipulation">+60d</button>'
    +'</div>'
  ...
  bg.innerHTML=
    ...
    +'<button id="sc-route-btn" style="border:none;background:#f0fdf4;border-radius:8px;padding:6px 10px;font-size:11px;font-weight:700;color:#059669;cursor:pointer;touch-action:manipulation;font-family:inherit">+Route</button>'
