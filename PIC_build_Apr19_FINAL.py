    ...
    <div style="display:flex;flex-direction:column;height:calc(100vh - 120px);gap:8px;overflow:hidden">
      ...
      <div class="dc" style="flex-shrink:0;padding:12px">
        ...
        <div style="display:flex;gap:6px">
          <button onclick="planMyDay()" ontouchend="event.preventDefault();planMyDay()"
          ...
          <button onclick="clearRoute()" ontouchend="event.preventDefault();clearRoute()"
...
function showCard(id){
  ...
  var logH='<div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:10px;padding:12px;margin-bottom:10px">'
    ...
    +'<button data-calmode="followup" onclick="showCal(0,this.dataset.calmode)" ontouchend="event.preventDefault();showCal(0,this.dataset.calmode)" style="width:100%;padding:10px;border:1px solid #e2e8f0;border-radius:8px;background:#f8fafc;color:#0f1f38;font-size:13px;font-weight:600;cursor:pointer;font-family:inherit;touch-action:manipulation">📅 Pick Follow-Up Date</button>'
  ...
  var wonH='<div style="margin-bottom:12px">'
    ...
    +'</div>'
    +'<button data-scwon="churned" onclick="scMarkWon(this.dataset.scwon)" ontouchend="event.preventDefault();scMarkWon(this.dataset.scwon)" style="width:100%;padding:8px;border:1px solid #e2e8f0;border-radius:8px;background:transparent;color:#94a3b8;font-size:10px;cursor:pointer;font-family:inherit;touch-action:manipulation">'
  ...
  if(wrap&&btns){
    if(reasons[o]){
      btns.innerHTML=reasons[o].map(function(r){
        return '<button data-screason="'+r.replace(/"/g,'&quot;')+'" onclick="scSetReason(this.dataset.screason)" ontouchend="event.preventDefault();scSetReason(this.dataset.screason)" style="padding:5px 9px;border:1px solid #e2e8f0;border-radius:5px;background:#fff;font-size:10px;cursor:pointer;font-family:inherit;touch-action:manipulation">'+r+'</button>';
      }).join('');;
