...
function showCard(id){
  ...
  var logH='<div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:10px;padding:12px;margin-bottom:10px">'
    ...
    +'<div style="display:flex;gap:6px;align-items:center;margin-bottom:8px;padding:6px 8px;background:#fff;border:1px solid #e2e8f0;border-radius:7px">'
    +'<span style="font-size:9px;color:#94a3b8;white-space:nowrap;font-weight:600">📅 Follow-up:</span>'
    +'<input type="date" id="sc-followup" style="flex:1;padding:4px;border:none;font-size:11px;font-family:inherit;background:transparent;color:#1e293b;outline:none">'
    +'</div>'
  ...
  bg.innerHTML=
    ...
    +'<div style="padding:16px">'
      ...
      +phoneH+iceH+intelH+pitchH+walkinH+objH+histH+logH+closeH+contactsH
    +'</div></div>';
  ...
  function doAddContact(e){
    ...
    if(!name)return;
    var role=prompt('Role (e.g. Owner, GM):') ||'';
