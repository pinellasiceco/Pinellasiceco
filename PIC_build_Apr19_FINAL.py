...
function showCard(id){
  ...
  var logH='<div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:10px;padding:12px;margin-bottom:10px">'
    ...
    +'<input type="date" id="sc-followup" style="flex:1;padding:10px;border:1px solid #e2e8f0;border-radius:6px;font-size:14px;font-family:inherit;background:#fff;color:#1e293b;outline:none;min-height:36px;touch-action:manipulation">'
    +'</div>'
  ...
  function doSaveLog(e){
    ...
    var needsFollowup=['not_now','in_play','voicemail','no_contact'].indexOf(selOutcome)>=0;
