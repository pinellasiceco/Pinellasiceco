...
*Last updated: 2026-05-15 (session 25d — 215 RLU update + playbook rework) by Claude Code*
...
| `docs/explore/index.html` | QR code hub page — `https://pinellasiceco.github.io/Pinellasiceco/docs/explore/` — 6-act scrolling page (hero, 457 vs 10 count-up, 3 stat cards, guarantee, features, 3-path CTA); printed on physical business cards |
