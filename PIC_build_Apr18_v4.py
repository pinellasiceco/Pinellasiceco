...
.qbtn { padding:10px 6px; border:none; border-radius:8px; font-size:11px; font-weight:700; cursor:pointer; font-family:inherit; touch-action:manipulation; -webkit-tap-highlight-color:rgba(0,0,0,.1); user-select:none; }
...
function renderQueueCard(){
  ...
  document.getElementById('queue-card-wrap').innerHTML=
    ...
    +'<button onclick="exitQueueMode();openM('+p.id+')" style="margin-top:8px;width:100%;padding:8px;border:1px solid var(--brd);border-radius:8px;background:transparent;color:var(--sub);font-size:11px;font-weight:600;cursor:pointer;font-family:inherit">&#x1F50D; View Full Details</button>'
    +'</div>';
}
